...
public class LoginActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bmob.initialize(this, "8312b01be8501a99f271db225a12b5ba");
            ...
            case R.id.btn_login: {
                ...
                user.login(new SaveListener<User>() {
                    public void done(User object, BmobException e) {
                        if (e == null) {
                            Toast toast =Toast.makeText(getBaseContext(), "登录成功", Toast.LENGTH_SHORT);
                            ...
                            edit.putString("USERNAME", object.getUsername());
                            edit.putString("USERPASSWORD", psw);
                            edit.putString("TELEPHONE", object.getTel());
                            edit.putString("OBJECTID", object.getObjectId());
                            edit.commit();


                            Intent intent = new Intent(LoginActivity.this, SelfActivity.class);
